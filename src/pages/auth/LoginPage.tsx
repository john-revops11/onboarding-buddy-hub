  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-12 lg:px-16 xl:px-24 bg-white relative overflow-hidden">
        {/* Decorative Circles */}
        <div className="absolute top-[-10%] right-[-10%] w-64 h-64 rounded-full bg-accentGreen-100 opacity-70"></div>
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-accentGreen-600 to-accentGreen-700 text-white relative">
        {/* Decorative Elements */}
        <div className="absolute top-[20%] right-[10%] w-64 h-64 rounded-full bg-accentGreen-400 opacity-10"></div>
        <div className="absolute bottom-[15%] left-[5%] w-48 h-48 rounded-full bg-accentGreen-400 opacity-10"></div>
        ...
        <div className="flex flex-col justify-center items-center p-12 w-full max-w-lg mx-auto">
          ...
          >
            ...
            <p className="mb-6 text-accentGreen-50 leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="ml-3 text-sm text-accentGreen-50">
